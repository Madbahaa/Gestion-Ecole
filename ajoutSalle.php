<?php 
  ...
  $req = "select CodeSalle from salle";
...
<!DOCTYPE html>
  <html>
    ...
    <form class="col s8" method="post" action="ajoutSalleFunction.php">
      <div class="row">
        <div class="input-field col s12">
          <input id="first_name" name="code" type="text" class="validate" required>
          <label for="first_name">Code Salle</label>
        </div>
    ...
    <br><br>
      ...
      <table>
        ...
        <tbody>
        <?php while($salle = mysqli_fetch_assoc($rs)){?>
          <tr>
